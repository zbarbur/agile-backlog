...
"""
        ...
        def render_board():
            ...
            if view_mode["current"] == "done":
                ...
                sprint_match_fn = _sprint_match if resolved_sprints else (lambda _s: True)
                render_done_view(
                    items=items,
                    search_query=sq,
                    priority_filter=pf_list,
                    category_filter=cf_list,
                    tag_filter_list=tf_list,
                    resolved_sprints=resolved_sprints,
                    sprint_match_fn=sprint_match_fn,
                    move_item=move_item,
                    refresh_board=render_board.refresh,
                )
