...
- **CLI** (`src/agile_backlog/cli.py`) — Click-based: add, list, move, edit, show, serve, note, flagged, set-sprint, resolve-note, sprint-status, validate
...
| 19 | CLI Power Tools + Adoption Guide | 204 | — |
